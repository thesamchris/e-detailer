		...
		<div className="about_us__content sonax_page__content">
			<div className="about_us__list">
				...
				<div className="about_us__list_item">
					...
					<p className="about_us__list_item_p sonax_page__p">
						SONAX is the market leader in car care products in Germany, and one
						of the leading manufacturers worldwide. The brand is represented in
						100 countries around the globe. For more than 60 years, the company
						has been developing and manufacturing high performance car care
						products, to satisfy the highest requirements, in Neuburg an der
						Donau. Whether it’s in motorsports, in the tuning scene or in the
						world of classic cars: When it comes to the perfect presentation of
						automobiles, SONAX will always be on hand, for car fans and experts.
						SONAX develops car care products that last longer, perform better
						and shine brighter. SONAX was one of the first car care companies to
						pro-actively develop environmentally friendly products and they are
						on the leading edge of nanotechnology.
					</p>
				</div>
			</div>
		</div>
